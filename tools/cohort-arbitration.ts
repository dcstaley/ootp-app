...
console.log(`shipped ramp constants (NOT refitted): K_SPREAD_PIT = {A ${K_SPREAD_PIT.A}, q ${K_SPREAD_PIT.q}, gMax ${K_SPREAD_PIT.gMax}} | PIT_SPREAD_HR = {A ${PIT_SPREAD_HR.A}, q ${PIT_SPREAD_HR.q}, gMax ${PIT_SPREAD_HR.gMax}}`);

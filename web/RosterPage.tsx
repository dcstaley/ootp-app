...
export function RosterPage() {
  ...
  const hitterCols: Column<RosterHitterRow>[] = [
    ...
    { key: "vL", label: "Off vL", align: "r", width: 66, value: (h) => h.wobaVL, render: (h) => <span title={OFF_TIP("LHP")}>{num(h.wobaVL)}</span> }, // 66 (not 58): fit the label + sort arrow
    { key: "vR", label: "Off vR", align: "r", width: 66, value: (h) => h.wobaVR, render: (h) => <span title={OFF_TIP("RHP")}>{num(h.wobaVR)}</span> },
